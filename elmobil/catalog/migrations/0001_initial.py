...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=256, verbose_name='Расположение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_cells', models.IntegerField(blank=True, help_text='шт.', null=True, verbose_name='Количество ячеек')),
                ('warranty_period', models.IntegerField(blank=True, help_text='лет', null=True, verbose_name='Срок гарантии')),
                ('warranty_mileage', models.IntegerField(blank=True, help_text='км', null=True, verbose_name='Гарантийный пробег')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_torque', models.IntegerField(blank=True, help_text='Нм', null=True, verbose_name='Крутящий момент')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('charge_power', models.DecimalField(blank=True, decimal_places=2, help_text='кВт⋅ч', max_digits=10, null=True, verbose_name='Мощность зарядки')),
                ('charge_time', models.DurationField(blank=True, help_text='ч:м:с', null=True, verbose_name='Время зарядки (до 80%)')),
                ('charge_speed', models.IntegerField(blank=True, help_text='км/ч', null=True, verbose_name='Скорость зарядки')),
